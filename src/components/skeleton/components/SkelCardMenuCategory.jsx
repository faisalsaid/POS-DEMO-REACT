...
const SkelCardMenuCategory = (props) => {
  return (
    <>
      {/* <MyFacebookLoader /> */}
      <ContentLoader width={500} height={100} viewBox="0 0 500 100" backgroundColor="#f3f3f3" foregroundColor="#ecebeb" {...props}>
...
export default SkelCardMenuCategory;
